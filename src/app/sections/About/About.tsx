    ...
    >
      ...
      <div className="flex items-center justify-center flex-col text-center p-4">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-6 text-lg font-semibold text-black z-10 mb-6">
          <div className="flex items-center gap-2 text-[#FFF107]">
        ...
        <p className="text-white max-w-2xl z-10 leading-loose mb-8">
          <span className={"bg-[#082FFF] mx-2 text-white font-bold"}>
          ...
          Whether you are releasing a new album, dropping a single, or planning
          a tour, effective music promotion strategies ensure your music doesn’t
          go unnoticed.
        </p>
      </div>
    </div>
