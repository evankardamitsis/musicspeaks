    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-center flex-col text-center p-4">
                {/* Heading */}
                <AboutHeading className="text-white w-[80%] max-w-3xl mb-12 z-10 ml-[50%] md:ml-[50%]" />

                {/* Subheadings with Icons */}
                <div className="flex flex-col sm:flex-row justify-center items-center gap-6 text-lg font-semibold text-black z-10 mb-6">
                    <div className="flex items-center gap-2 text-white">
                       <h3> PROMOTE A NEW RELEASE</h3>
                        <YellowIcon animate={true} className="w-8 h-8" />
                    </div>
                    <div className="flex items-center gap-2 text-white">
                    ...
                    <div className="flex items-center gap-2 text-white">
                       <h3> CREATE YOUR DIGITAL PRESENCE</h3>
                        <YellowIcon animate={true} className="w-8 h-8 justify-center" />
                    </div>
                </div>

                {/* Description */}
                <p className="text-white max-w-2xl z-10 leading-loose">
                    <span className={"bg-[#082FFF] mx-2 text-white font-bold"}>Your music deserves to be heard,</span>and with well-crafted music marketing strategies, you can increase
