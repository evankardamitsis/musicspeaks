        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-4">
              ...
              <li>
                <strong>Country</strong> refers to: Greece
              </li>
              <li>
                <strong>Company</strong> (referred to as either &quot;the
                Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot;
                in this Agreement) refers to Music Speaks.
              </li>
              <li>
              ...
              <li>
                <strong>Website</strong> refers to Music Speaks, accessible from
                musicspeaks.gr
              </li>
              <li>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold mb-4">Waiver</h3>
            <p>
          ...
          <section>
            ...
            <p>
              By email:{" "}
              <a
                href="mailto:info@musicspeaks.gr"
